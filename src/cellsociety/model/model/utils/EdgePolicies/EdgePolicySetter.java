...
/**
 * helper class that takes a string and returns an edgepolicy. Allows the user to pick from a
 * dropdown list of strings and change the edge policy
 *
 * @Author Albert Yuan
 */
public class EdgePolicySetter {
  ...
  public EdgePolicies setEdgePolicy(String type) {
    String edgePolicyType = String.format("cellsociety.model.model.utils.EdgePolicies.%sEdgePolicy",
        type);
